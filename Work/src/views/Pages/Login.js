...
const LoginCover = (props) => {
  ...
  const handleSubmitEmail = async () => {
    // Enable hack for mock emails to bypass real verification
                      ...
                      <Form onSubmit={onSubmit}>
                        ...
                        <div style={{ padding: width > 787 && "4rem" }}>
                          ...
                          <div className="mb-3 p-1 border rounded bg-light">
                            <small className="text-muted d-block mb-1">Testing Credentials (Local Storage Mode):</small>
                            <div className="d-flex flex-wrap gap-1">
                              {['admin@test.com', 'candidate@test.com', 'client@test.com', 'recruiter@test.com'].map(mockEmail => (
                                <Button
                                  key={mockEmail}
                                  size="sm"
